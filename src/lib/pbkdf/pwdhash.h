...
class BOTAN_PUBLIC_API(2,8) PasswordHash
   ...
   public:
      ...
      */
      static std::unique_ptr<PasswordHash> create(const std::string& algo_spec,
      ...
      */
      static std::unique_ptr<PasswordHash>
      ...
      */
      ...
      class BOTAN_PUBLIC_API(2,8) Params
         {
         public:
      ...
      */
      virtual std::unique_ptr<Params> tune(size_t output_len, uint32_t msec) const = 0;
      ...
      */
      virtual std::unique_ptr<Params> default_params() const = 0;
   };
